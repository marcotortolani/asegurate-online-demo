...
export default function ContactButton() {
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <Link
        href="/"
        className="group relative bg-secondary font-platform-regular text-2xl text-white px-4 py-3 rounded-2xl rounded-br-none flex items-center gap-3 hover:bg-secondary-dark transition-colors"
      >
        Contacto
        <Image
          src={atencionIcono}
